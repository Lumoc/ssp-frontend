...
<template>
    <div>
        <div class="hero is-light">
            <div class="hero-body">
                <div class="container">
                    <h1 class="title"><i class="material-icons">cloud</i> Get Ansible Template details</h1>
                </div>
                <h2 class="subtitle">
                    Get Ansible Template details. All orders are logged and will be billed.
                </h2>
            </div>
        </div>
        <br>
        <form v-on:submit.prevent="newECSdetails">
