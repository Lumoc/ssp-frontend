<template>
    <div>
        <div class="hero is-light">
            <div class="hero-body">
                <div class="container">
                    <h1 class="title"><i class="material-icons">edit</i>DevProxy</h1>
                </div>
        ...
        <form v-on:submit.prevent="createApiToken">
            <button class="button is-primary">Create token</button>
        </form>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            createApiToken: function() {
                this.loading = true;
                this.$http.get(this.$store.state.wzuURL + '/api/squid/getApiKey').then(() => {
                    this.loading = false;
                }, () => {
                    this.loading = false;
                });
